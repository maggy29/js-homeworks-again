...
// одно. Это позволяет переиспользовать код и изменять логику работы функции
 ...
 */
console.log(isLoginValid('Cat'));
console.log(isLoginValid('Frienf'));
console.log(isLoginUnique('Frienf'));
console.log(isLoginUnique(logins, 'qwerty123'));
console.log(isLoginValid('MymzikkozlenochekMerzkiy'));
